...
Insight is generated by Upgraded Humans in the active timeline and is currently spent in a first-pass Insight VR menu.

Current Insight VR actions:

- `Shared Inquiry`
  - Toggle.
  - Spends up to 100 Insight per turn for Scientific Research.
...
- `Shared Triage`
  - Toggle.
  - Spends Medical-Grade Nanobots to repair damaged player structures and machine actors after normal repair jobs.
- `Protocol Compression`
  - One-time Wisdom purchase.
  - Permanently improves Insight income.
- `Consent Cascade`
  - First activation costs Compassion.
  - While active, costs Insight per turn.
...
Grey Goo stacks, deals delayed damage, does not tick down, and can spread to nearby enemies when a target dies. The current implementation is intentionally useful, but not final balance.
